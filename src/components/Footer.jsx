      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-bold text-white mb-4">EduHub</h3>
            <p className="mb-4 text-sm md:text-base">Transform your learning journey with our innovative platform.</p>
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-bold text-white mb-4">Resources</h3>
            <ul className="space-y-2 text-sm md:text-base">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-bold text-white mb-4">Contact Us</h3>
            <p className="text-sm md:text-base mb-2">Email: support@eduhub.com</p>
