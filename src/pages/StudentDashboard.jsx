        ...
        <div className="flex-1 p-4 md:p-8">
          ...
          <div className="bg-background-secondary p-4 md:p-6 rounded-lg mb-6 md:mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-violet-400 hover:text-violet-300 text-sm md:text-base">VIEW ALL</button>
            </div>
            <div className="flex space-x-3 md:space-x-4 overflow-x-auto pb-2">
              {rewards.map((_, index) => (
                <div key={index} className="w-10 h-10 md:w-12 md:h-12 flex-shrink-0 rounded-full bg-violet-700 flex items-center justify-center">
